...
DEFAULT_MAX_RETRIES = max(1, int(os.environ.get("MX_MACRO_DATA_MAX_RETRIES", "3") or "3"))
DEFAULT_RETRY_DELAY_SEC = max(0.5, float(os.environ.get("MX_MACRO_DATA_RETRY_DELAY_SEC", "1.5") or "1.5"))
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            for attempt in range(1, DEFAULT_MAX_RETRIES + 1):
                ...
                if data is not None and "操作过于频繁" not in message:
                    break
