...
SDK_MODULE_NAME = "futu"  # 实际使用的 SDK 模块名，"moomoo" 或 "futu"


def ensure_futu_api():
    """确保 moomoo-api 或 futu-api 已安装，未安装则自动安装 moomoo-api"""
    global SDK_MODULE_NAME
    try:
        import moomoo
        SDK_MODULE_NAME = "moomoo"
        return True
    except ImportError:
        pass
    try:
        import futu
        SDK_MODULE_NAME = "futu"
        return True
    except ImportError:
        pass
